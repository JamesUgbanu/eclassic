...
const routes = (app) => {
  ...
  app.put('/api/v1/products/:id', checkNewProduct, validation.validatorError, ProductController.updateProduct);
  app.delete('/api/v1/products/:id', ProductController.removeById);
};
